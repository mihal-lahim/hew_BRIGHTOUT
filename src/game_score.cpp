/*==============================================================================
   ...
   �X�R�A�̊Ǘ��ƕ\�� [game_score.cpp]
														 Author : sumi rintarou
														 Date   : 2025/09/05
--------------------------------------------------------------------------------

==============================================================================*/
#include "../include/game_score.h"
...
{
	// �g�̕`��
	Sprite_Draw(g_gazou_waku, -17, -95, 666, 375, 0, 0, 666, 375);// �g
...
void numberDraw(int number, float x, float y)
{
	Sprite_Draw(g_ScoreTexId, x, y, 700 / 10, 437 / 5, number * 69, 100, 700 / 10, 700 / 10);// �D

	//Sprite_Draw(g_ScoreTexId, x, y, 700 / 10, 437 / 5, number * 69, 270, 700 / 10, 700 / 10);// ��
}
